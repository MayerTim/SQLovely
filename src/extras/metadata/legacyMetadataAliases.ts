export function legacyVersionPatterns(): readonly RegExp[] {
  return [/^\s*(?:version|vers\.?|ver\.?)\s*[:=]\s*v?([0-9]+(?:[.,][0-9]+){0,3})\b/iu];
}
